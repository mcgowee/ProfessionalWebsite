...
function ServiceCard($$payload, $$props) {
  ...
  $$payload.out += `<!--]--></div> <div class="flex items-center"><button class="specialBtnDark mr-auto font-semibold"><p>Contact Me →</p></button></div></div> <div${attr("class", "flex flex-col dropShadow overflow-hidden rounded-b-lg ")}><div class="rounded-t-xl h-8 sm:h-10 bg-white opacity-60 px-3 flex items-center gap-2"><!--[-->`;
  for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
    each_array_1[$$index_1];
    $$payload.out += `<div class="rounded-full aspect-square w-2.5 sm:w-3 bg-indigo-300"></div>`;
  }
  $$payload.out += `<!--]--></div> <div class="flex flex-col bg-white gap-4 flex-1"><img${attr("src", serviceFeature.imgUrl)} alt="service-img"></div></div></div>`;
