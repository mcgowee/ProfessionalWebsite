...
import {
  ...
  useActions
} from "./chunk-VDRM673S.js";
import {
  ponyfill_exports
} from "./chunk-T2OSJHBX.js";
import {
  SvelteComponentDev,
  action_destroyer,
  add_location,
...
function instance_1($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    $$invalidate(41, instance6 = new MDCListFoundation({
    ...
    const accessor = {
      ...
      get typeaheadInProgress() {
        return instance6.isTypeaheadInProgress();
      },
      typeaheadMatchItem(nextChar, startingIndex) {
        return instance6.typeaheadMatchItem(
          nextChar,
          startingIndex,
          /** skipFocus */
          true
  ...
  function handleKeydown(event) {
    if (instance6 && event.target) {
      instance6.handleKeydown(event, event.target.classList.contains("mdc-deprecated-list-item"), getListItemIndex(event.target));
    }
  }
  function handleFocusin(event) {
    if (instance6 && event.target) {
      instance6.handleFocusIn(getListItemIndex(event.target));
    }
  }
  function handleFocusout(event) {
    if (instance6 && event.target) {
      instance6.handleFocusOut(getListItemIndex(event.target));
    }
  }
  function handleClick(event) {
    if (instance6 && event.target) {
      instance6.handleClick(getListItemIndex(event.target), !matches(event.target, 'input[type="checkbox"], input[type="radio"]'), event);
    }
  }
  ...
  function setEnabled(itemIndex, isEnabled) {
    return instance6.setEnabled(itemIndex, isEnabled);
  }
  function getTypeaheadInProgress() {
    return instance6.isTypeaheadInProgress();
  }
  function getSelectedIndex() {
    return instance6.getSelectedIndex();
  }
  function getFocusedItemIndex() {
    return instance6.getFocusedItemIndex();
  }
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("element" in $$props) $$invalidate(14, element2 = $$new_props.element);
    if ("instance" in $$props) $$invalidate(41, instance6 = $$new_props.instance);
  ...
  $$self.$$.update = () => {
    ...
    1024) {
      $: if (instance6) {
        instance6.setVerticalOrientation(vertical);
      }
    }
    ...
    1024) {
      $: if (instance6) {
        instance6.setWrapFocus(wrapFocus);
      }
    }
    if ($$self.$$.dirty[1] & /*instance, hasTypeahead*/
    1028) {
      $: if (instance6) {
        instance6.setHasTypeahead(hasTypeahead);
      }
    }
    ...
    1024) {
      $: if (instance6) {
        instance6.setSingleSelection(singleSelection);
      }
    }
    ...
    1024) {
      $: if (instance6) {
        instance6.setDisabledItemsFocusable(disabledItemsFocusable);
      }
    }
    if ($$self.$$.dirty[0] & /*singleSelection, selectedIndex*/
    603979776 | $$self.$$.dirty[1] & /*instance*/
    1024) {
      $: if (instance6 && singleSelection && getSelectedIndex() !== selectedIndex) {
        instance6.setSelectedIndex(selectedIndex);
      }
    }
  };
  return [
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 58, 15, 1832);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("element" in $$props) $$invalidate(17, element2 = $$new_props.element);
...
function instance2($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    if ("use" in $$props) $$invalidate(0, use = $$new_props.use);
    if ("className" in $$props) $$invalidate(1, className = $$new_props.className);
    if ("element" in $$props) $$invalidate(4, element2 = $$new_props.element);
...
function instance3($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    if ("use" in $$props) $$invalidate(0, use = $$new_props.use);
    if ("className" in $$props) $$invalidate(1, className = $$new_props.className);
    if ("element" in $$props) $$invalidate(2, element2 = $$new_props.element);
...
function instance5($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("element" in $$props) $$invalidate(9, element2 = $$new_props.element);
    if ("nav" in $$props) nav = $$new_props.nav;
...
//# sourceMappingURL=chunk-NYTE7RTS.js.map
