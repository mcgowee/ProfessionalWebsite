import {
  MDCRippleFoundation,
  util_exports
} from "./chunk-2BL6MOKQ.js";
import {
  events_exports
} from "./chunk-GK6IWRTL.js";
import {
  ponyfill_exports
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("element" in $$props) $$invalidate(5, element2 = $$new_props.element);
...
function create_dynamic_element_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svelte_element, file, 16, 2, 316);
    },
    m: function mount(target, anchor) {
...
function create_dynamic_element(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svelte_element, file, 8, 2, 170);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, svelte_element, anchor);
...
function instance3($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    if ("use" in $$props) $$invalidate(0, use = $$new_props.use);
    if ("element" in $$props) $$invalidate(1, element2 = $$new_props.element);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
//# sourceMappingURL=chunk-XV6M2LD5.js.map
